...
export default function Signup() {
    ...
    const allSteps: Step[] = ["auth", "company", "confirm"];
                        ...
                        <Card className="glass-card border-border/50 shadow-2xl shadow-purple-500/10">
                            ...
                            <CardContent className="space-y-4">
                                        ...
                                        <div className="grid gap-3">
                                            {enabledProviders.includes('google') && (
                                                <Button
                                                    ...
                                                    onClick={() => { setAuthMethod('google'); setStep('company'); }}
                                                >
                                            ...
                                            {enabledProviders.includes('facebook') && (
                                                <Button
                                                    ...
                                                    onClick={() => { setAuthMethod('facebook'); setStep('company'); }}
                                                >
                                                    <svg className="w-5 h-5 mr-3 transition-transform group-hover:scale-110" viewBox="0 0 24 24">
                                            ...
                                            {enabledProviders.includes('microsoft') && (
                                                <Button
                                                    ...
                                                    onClick={() => { setAuthMethod('microsoft'); setStep('company'); }}
                                                >
                                                    <svg className="w-5 h-5 mr-3 transition-transform group-hover:scale-110" viewBox="0 0 24 24">
                                ...
                                <Button
                                    ...
                                    onClick={() => { setAuthMethod('email'); setStep('company'); }}
                                >
                                    Siguiente
